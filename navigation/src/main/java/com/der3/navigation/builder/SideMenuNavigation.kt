...
import com.der3.home.presentations.side_menu.rate_us.RateUsRoute
import com.der3.home.presentations.side_menu.share_app.ShareAppRoute
...
fun NavGraphBuilder.sideMenuNavigation(rootNavController: NavHostController) {
    ...
    composable<Der3NavigationRoute.RateScreen> {
        RateUsRoute(
            onNavigate = { screen ->
                rootNavController.navigateTo(screen)
            }
